...
import priv.marionette.shell.SystemProperties;
...
public class IOUtils {
    ...
    public static void copyFiles(String original, String copy) throws IOException {
        InputStream in = FileSystemOperation.newInputStream(original);
        OutputStream out = FileSystemOperation.newOutputStream(copy, false);
        copyAndClose(in, out);
    }
