...
public class StringUtils {
    ...
    private static String[] getCache() {
        ...
        try {
            cache = new String[SystemProperties.OBJECT_CACHE_SIZE];
...
//                break;
    ...
    public static String cache(String s) {
        if (!SystemProperties.OBJECT_CACHE) {
            return s;
        }
        if (s == null) {
            return s;
        ...
        if (cache != null) {
            int index = hash & (SystemProperties.OBJECT_CACHE_SIZE - 1);
